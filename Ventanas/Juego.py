...
class Juego(MDScreen):
    ...
    def __contenido_canvas(self):
        ...
        self.objeto1 = Objetos("suelo", self.manejadorSprites.get_objetos(1),[0,0],self.tamanio_cuadro)
        self.dibujado_objetos.append(Objetos("suelo", self.manejadorSprites.get_objetos(1),[0,0],self.tamanio_cuadro))
        self.dibujado_objetos.append(Objetos("suelo", self.manejadorSprites.get_objetos(2),[self.tamanio_cuadro[0]*1,0],self.tamanio_cuadro))
        self.dibujado_objetos.append(Objetos("suelo", self.manejadorSprites.get_objetos(3),[self.tamanio_cuadro[0]*2,0],self.tamanio_cuadro))
        self.dibujado_objetos.append(Objetos("suelo", self.manejadorSprites.get_objetos(4),[self.tamanio_cuadro[0]*3,0],self.tamanio_cuadro))
        self.dibujado_objetos.append(
            Objetos("suelo", self.manejadorSprites.get_objetos(5), [self.tamanio_cuadro[0] * 5, self.tamanio_cuadro[1] * 5],
                    self.tamanio_cuadro))
